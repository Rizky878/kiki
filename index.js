...
//
const BotName = 'BOT ./Rizkybot'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/_rizkyfadilah8/'; // Nama Instagramlu cok
const whatsapplu = '082387804410'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/LLCSpSL2S8A1NJwTnMIgWY'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/LLCSpSL2S8A1NJwTnMIgWY'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
